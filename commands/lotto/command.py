...
class Command(u.Command):
    ...
    async def execute(context: u.CommandContext):
        ...
        slot1 = [images[random.randint(0, len(images) - 1)], images[random.randint(0, len(images) - 1)],
                 images[random.randint(0, len(images) - 1)]]
        slot2 = [images[random.randint(0, len(images) - 1)], images[random.randint(0, len(images) - 1)],
                 images[random.randint(0, len(images) - 1)]]
        slot3 = [images[random.randint(0, len(images) - 1)], images[random.randint(0, len(images) - 1)],
                 images[random.randint(0, len(images) - 1)]]
